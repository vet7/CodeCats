...
function show_ref3() {
  ...
  document.getElementById("forth_a").innerHTML = "With the help of my group I have learned how to structure a group project more effectively such as having a task-based timeline and keeping well documented minutes through MS Teams. Signing defined tasks early on is vital when it comes to meeting deadlines. ";
}
...
function show_ref4() {
  ...
  document.getElementById("second_a").innerHTML = "The only thing that could be improved is that we should have defined clearer leadership early on and managed dividing tasks a little better. For most of the start of this assignment, we did not assign a leadership role as it did not seem like one was necessary at the time. I feel that this might have been a mistake as it made delegation and a better structure to our work a little harder to assign. Fortunately, we did realize this, and Chelsea took the initiative to fill a leadership position. After this, our work became a lot more structured and organised.";
